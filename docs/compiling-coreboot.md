...
6. **Download flashrom, then give it execute permission.**
    * `cd; curl -LO https://cdn.discordapp.com/attachments/232609321274310656/1168575883980836894/flashrom; chmod +x flashrom`
7. **Flash your custom ROM**
    * Backup your current rom, just in case things go wrong: `./flashrom -p internal -r current.rom`
    * Flash your custom firmware: `sudo ./flashrom -p internal -w ~/dev/firmware/coreboot_edk2-<boardname>-mrchromebox_<yearmonthdate>.rom` 
8. **Reboot**
